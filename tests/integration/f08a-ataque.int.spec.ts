...
// `mx_isn_tasas_estatales`, `tax_tables` son GLOBALES —sin tenant_id ni entity_id—, así que
// las comparte toda la corrida. Este archivo siembra tarifas de ISR de un año sintético y tasas de ISN de
