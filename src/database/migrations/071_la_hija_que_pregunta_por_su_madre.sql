-- ============================================================
-- 071 · LA HIJA QUE PREGUNTA POR SU MADRE, UNA VEZ POR FILA (E1b)
--
...
COMMENT ON FUNCTION hija_hereda_inquilino() IS
  'Deriva tenant_id del padre en las tablas hija (071/E1b). La columna es un hecho derivado, no un dato del llamador: así ningún INSERT puede olvidarla ni contradecir al padre.';
