...
| `plan-de-cierre.html` | Los quince paquetes originales de trabajo (E0.0 a E5.1), con sus 147 tareas | Absorbido en `docs/HISTORY.md` §7 — ver ahí qué se cerró, en qué tramo, y qué sigue sin reverificar |
