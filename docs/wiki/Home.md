...
- **[[El-idioma-del-codigo]]** — el código en inglés, la interfaz en el idioma del usuario con el español primero, y lo que es dato y no se toca: tres capas, tres tratamientos, y el orden para llegar.
