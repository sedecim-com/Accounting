...
El núcleo: partida doble y posteo por una sola puerta, las siete reglas de validación, reversión y anulación, arrastre de saldos, integridad del mayor, conversión FX. El CFDI de punta a punta: analizador, hechos, taxonomía, decisiones de deducibilidad con cita de ley, clasificador y plan de posteo; el IVA sobre base de flujo y la ligadura del REP; la consulta de estatus ante el SAT; la custodia de e.firma en bóveda. La nómina mexicana y la estadounidense tienen todos sus motores escritos —ISR, subsidio, IMSS, INFONAVIT, finiquito, CFDI N, SUA, IDSE; FIT, FICA, Medicare, FUTA, SUTA, SIT, SDI, 941/940/W-2/W-3/EFW2, NACHA, beneficios—, pero la mayoría queda en **parcial** por lo que dice la sección siguiente: sólo FICA y Medicare están completos de punta a punta. Conciliación bancaria con cotejo, sesiones y partidas conciliatorias. Los ciclos de clientes y proveedores con sus controles auxiliares.
...
- **La nómina de Estados Unidos** tiene todos los motores y **tablas de otro año**: la semilla «2026» trae el tope de Seguro Social de 2024, los límites de 401(k), deducción estándar y FSA de 2025 y bandas FIT que no cuadran con la Pub 15-T; treinta y nueve de las cincuenta y una jurisdicciones de impuesto estatal no tienen tabla y devuelven cero. Y **declara ceros**: los formularios 941 y 940 suman una tabla que nadie escribe, los impuestos locales no se persisten (la casilla 19 del W-2 sale en cero), una orden de embargo porcentual retiene cero porque el motor y el esquema usan vocabularios distintos, y regenerar un W-2 lo duplica porque la tabla no tiene índice único.
- **La nómina mexicana** sólo tiene puerta REST —ni CLI ni herramientas del agente—; sin fila del año en `tax_parameters`, el IMSS deja las tasas en cero y el INFONAVIT aplica un 5 % quemado, ambos sobre una UMA quemada; toda frecuencia distinta de la quincenal retiene con la tarifa mensual; el SUA e IDSE emiten un formato «simplificado» que no es el del IMSS; y **el posteo al mayor revienta** en cualquier corrida donde el subsidio de un trabajador supere a su ISR.
