...
La investigación del 2026-09-06 ([`docs/investigacion/2026-09-06-normas-y-motores/`](investigacion/2026-09-06-normas-y-motores/)) añadió una tercera clase de trabajo, con etiqueta `jurisdiccion`: el tramo **J0** —la jurisdicción como dimensión, diseñado en [`docs/jurisdicciones.md`](jurisdicciones.md)— que va antes de cualquier motor nuevo por país; los índices **J1** (lo que Estados Unidos exige y no existe) y **J2** (lo que México exige y no existe fuera de F07/F08/T8/T18); los corpus normativos **N1** (US GAAP) y **N2** (fiscal MX/US) para el agente; y cinco defectos nuevos de la Vía A (T19–T23) que los escépticos encontraron al verificar el inventario de motores.
