...
1. `src/services/jurisdiccion/jurisdiccion.ts:201` — el identificador está en `:206` (archivo movido después del inventario; no es error de método sino de blanco móvil).
